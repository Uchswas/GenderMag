    ...
    "Subgoals": [
        {
            ...
            "answers": "Yes",
            "image" :  BASE_IMAGE_PATH+"POPL2029HomePage.png",
            ...
            "Actions": [
                {
                    ...
                    "before_action": {
                        ...
                        "page_on_which_abi_take_the_action": BASE_IMAGE_PATH+"POPL2029HomePage.png",
                        "answers": [
                    ...
                    "after_action": {
                        ...
                        "page_on_which_abi_is_after_the_action": BASE_IMAGE_PATH+"POPL2029HomePage.png",
                        "answers": [
                ...
                },
                {
                    ...
                    "after_action": {
                        "question": "If Abi does the right thing, will s/he know that s/he did the right thing and is making progress toward their goal? Why?",
                        "page_on_which_abi_is_after_the_action": BASE_IMAGE_PATH+"POPL2019Distin.png",
                        "answers": [
                ...
                },
                {
                    ...
                    "before_action": {
                        "question": "Will ABI know what to do at this step? Why?",
                        "page_on_which_abi_take_the_action": BASE_IMAGE_PATH+"POPL2019Distin.png",
                        "answers": [
                ...
                },
                {
                    ...
                    "after_action": {
                        "question": "If Abi does the right thing, will s/he know that s/he did the right thing and is making progress toward their goal? Why?",
                        "page_on_which_abi_is_after_the_action": BASE_IMAGE_PATH + "POPL2018Tutorial.png",
                        "answers": [
