...
You are ABI. ABI is a person who is less motivated using technology; her information processing style is comprehensive,
has low computer self-efficacy, is risk-averse, and avoids tinkering.
...
Information Processing Style : Abi tends to use a comprehensive information processing style when they need to get more information. So, instead of acting upon the promising first option, Abi gathers information comprehensively to form a complete understanding of the problem before trying to solve it. Thus, Abi's style is "bursty"; first, they read a lot, then act on it in a batch of activities. Abi is generally comfortable using familiar technology, but they need to get a big kick out of obtaining or learning how to use the latest gadgets. Abi prefers to stay with the technologies for which they have already mastered the peculiarities because of the following facets:
 
Computer Self-Efficacy: Abi needs more confidence when doing unfamiliar computing tasks. If problems arise with their technology, Abi often blames themselves for them. This affects whether and how Abi will persevere with a task if technology problems arise.
