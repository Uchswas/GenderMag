            ...
            "Actions": [
                {
                    ...
                    "after_action": {
                        ...
                        "answers": [
                            "answer1: Yes; facets: Motivations, Information Processing Style; why: She is going to read the whole list. (mot) She is looking for Visa...and she sees visa."
                        ]
                    }
                },
                {
                ...
                },
                {
                    ...
                    "after_action": {
                        ...
                        "page_on_which_abi_is_after_the_action": BASE_IMAGE_PATH + "ICSE2019Visa.png",
                        "answers": [
                            "answer1: Yes; facets: Attitude Towards Risk, Learning Style; why: Catch 22... she has to spend the registration $$ before she knows she will get the visa. Is she eligible for a refund if the visa is denied? She wants to know a bit more information. There is also a process outlined."
                        ]
                    }
                }
            ]
